...
export const DATABASE_ACTIONS = Object.freeze({
  ...
  BV_VIEW_CALENDAR_INVITEE_PERMISSIONS: 'BV_VIEW_CALENDAR_INVITEE_PERMISSIONS',
  BV_UPDATE_CALENDAR_INVITEE_PERMISSION: 'BV_UPDATE_CALENDAR_INVITEE_PERMISSION',
...
export function databaseActionForRpc(name, args = {}) {
  const fixed = {
    ...
    get_calendar_invitee_permissions: DATABASE_ACTIONS.BV_VIEW_CALENDAR_INVITEE_PERMISSIONS,
    set_calendar_invitee_permission: DATABASE_ACTIONS.BV_UPDATE_CALENDAR_INVITEE_PERMISSION,
  ...
  if (name === 'get_server_day_start') return isClientView()
    ? DATABASE_ACTIONS.CV_VIEW_MY_APPOINTMENTS
    : DATABASE_ACTIONS.BV_VIEW_PENDING_APPOINTMENTS;
