...
test('Enrollment edge adapter: authentication, SMS provider proof, and fixed recipient', async t => {
  ...
  const env={ TWILLIO_ACCOUNT_SID:'AC'+'a'.repeat(32), TWILLIO_AUTH_TOKEN:'test-token', TWILLIO_VERIFY_SERVICE_SID:'VA'+'a'.repeat(32), RESEND_API_KEY:'test', INVITE_FROM_EMAIL:'test@example.com' };
