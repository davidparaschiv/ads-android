...
test('Hand-drawn BV and CV screens keep separate navigation and exact controls',async t=>{
  ...
  await w.testApi.store.set({business:{id:'atelier-luna',name:'Atelier Luna',is_owner:true},demoAccess:{source:'developer',calendarLimit:5,expiresAt:'infinity'},demoCalendars:[{id:'demo-calendar-1',name:'Manichiură semipermanentă',is_active:true},{id:'demo-calendar-2',name:'Pedichiură',is_active:true}]});
